...
import edu.berkeley.cs.amplab.spark.indexedrdd.IndexedRDD.Id
import edu.berkeley.cs.amplab.spark.indexedrdd.IndexedRDDPartition.Index
 ...
 */
private[indexedrdd] class IndexedRDDPartition[@specialized(Long, Int, Double) V](
    val index: Index,
